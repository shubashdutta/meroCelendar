          ...
          <div className="col-lg-9">
            <div className="centerdivtopitem">
              ...
              <Link to="/merocalendar">
                <button className=" d-flex justify-content-end bg-danger p-2 rounded text-white">
                  <IoCalendarSharp
            ...
            <div className="mail-tools tooltip-demo m-t-md">
              <div className="btn-group float-right mb-2 mx-1">
                <button className="btn btn-default btn-lg large-width">
                  Yearly
                </button>
                <button
                  className="btn btn-default btn-lg large-width"
              ...
              <div className="header-button">
                <div className="btn-group mb-2 mx-1">
                  <button
                  ...
                  >
                    <li className="dropdown-item">A.D.</li>
                    <li className="dropdown-item">B.S.</li>
                  </ul>
                </div>
                <div className="btn-group mb-2 mx-1">
                  <button
                  ...
                  <button className="btn btn-default btn-lg px-4" title="Next">
