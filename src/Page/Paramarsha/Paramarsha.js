    ...
    <>
      <div className="banner-wrapper">
        <div className="paramarsh-banner">
          <img src="https://api.nepalipatro.com.np/storage/banners/0WiiYwWtXFTDpwF2.jpg" alt="" />
        </div>
      ...
      <div className="container position-relative" style={{marginTop: "-2rem", zIndex: "1"}}>
        <div className="bg-color border-radius" style={{padding: "40px 20px"}}>
          <div className="container">
            <div className="grid column-4">
              {Paramarshadata.map((data, key) => (
                <div className="item">
                  <div div className="paramasha_insidediv">
                    <img src={data.ImgUrl} alt="paramshaimg" />
