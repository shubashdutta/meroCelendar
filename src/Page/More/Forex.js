        ...
        <div className="row">
          ...
          <div className="col-lg-8 pt-3">
            <div className="bg-color">
              ...
              <p>
                Forex rates, also known as foreign exchange rates, are the rates
                at which one currency can be exchanged for another. These rates
                fluctuate constantly, as they are influenced by a variety of
                factors such as economic conditions, political events, and
                supply and demand for particular currencies.
              </p>

              <p>
                Forex rates are typically quoted in pairs, with the first
                currency being the base currency and the second currency being
                the quote currency. If the forex rate for the exchange rate
                between the Nepalese rupee (NRs) and the US dollar (USD)
                fluctuates constantly, as it is influenced by a variety of
                factors such as economic conditions, political events, and
              ...
              <p>
                ...
                Patro app or web for daily updated rates. Nepali patro can
                provide you with the current exchange rate between the two
                currencies, and allow you to calculate the equivalent value in
                your options of currency for a given amount of NRs.
              </p>
