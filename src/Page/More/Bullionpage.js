        ...
        <div className="main-div-goldpage row">
          ...
          <div className="Gold_page_center col-lg-9 mt-3">
            <div className="bg-color p-0 p-4">
              ...
              <p>
                Bullion refers to gold, silver, or other precious metals that
                are valued for their purity and rarity. In Nepal, bullion is
                traded as a commodity and is often used as a store of value or
                as an investment.
              </p>
              <p>
                It is important to note that the value of bullion (Daily Gold
                Silver Rates) can fluctuate significantly, as it is influenced
                by a variety of factors such as market demand, economic
